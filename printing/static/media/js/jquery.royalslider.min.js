...
(a._o5.removeClass("rsNavSelected"),a._o5=null),a._m6&&a._n6(a.currSlideId),a._o5=e.addClass("rsNavSelected"))}),a.ev.on("rsOnAppendSlide",function(e,c,b){e="<div"+a._o6+' class="rsNavItem rsThumb'+c+'">'+a._p6+c.thumbnail+"</div>";b>=a.numSlides?a._s3.append(e):a._m5.eq(b).before(e);a._m5=a._s3.children();a.updateThumbsSize()}),a.ev.on("rsOnRemoveSlide",function(e,c){var b=a._m5.eq(c);b&&(b.remove(),a._m5=a._s3.children(),a.updateThumbsSize())}))},_l6:function(){var a=this,e="rsThumbs",c=a.st.thumbs,
b="",g,d,h=c.spacing;a._k5=!0;a._e3="vertical"===c.orientation?!1:!0;a._o6=g=h?' style="margin-'+(a._e3?"right":"bottom")+":"+h+'px;"':"";a._i3=0;a._q6=!1;a._n5=!1;a._m6=!1;a._r6=c.arrows&&c.navigation;d=a._e3?"Hor":"Ver";a.slider.addClass("rsWithThumbs rsWithThumbs"+d);b+='<div class="rsNav rsThumbs rsThumbs'+d+'"><div class="'+e+'Container">';a._p6=c.appendSpan?'<span class="thumbIco"></span>':"";for(var j=0;j<a.numSlides;j++)d=a.slides[j],b+="<div"+g+' class="rsNavItem rsThumb thumb_'+j+'">'+d.thumbnail+a._p6+
